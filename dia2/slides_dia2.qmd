...
## Unix e Windows não falam igual {.vcenter-slide}

:::: {.terminal-os-table-body}
::: {.product-table .terminal-os-table}
...
Vale conhecer: [The Missing Semester of Your CS Education](https://missing.csail.mit.edu/)
...
O terminal é uma das principais ferramentas do agente: por ali ele enxerga a estrutura do projeto, executa scripts, lê erros e confirma se a mudança funcionou.
